...
class ModalClass {
  ...
  isPopup() {
    if (!this.popup.closed && (typeof bgQueue !== 'undefined') && bgQueue.isLoggedOff()) setTimeout(this.isPopup.bind(this), 500);
    else if (typeof bgQueue !== 'undefined') bgQueue.nowLoggedOn();
  }
