...
allTabs("/searchCrazy.html", count => { if (count<2) startSearchCrazy(); else {
  displayDebuggerError(`Error starting SearchCrazy Page.`,`You have SearchCrazy Page running in another tab or window. You can't have multiple instances running or it will cause database problems.`);
}});
